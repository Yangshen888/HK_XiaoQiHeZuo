<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="EmployeeList.aspx.cs" Inherits="HaikanSchoolProjects.General.Employee.PersonList" %>
                ...
                <div id="mymain">
                    ...
                    <blockquote class="layui-elem-quote">
                        <div style="margin-bottom: auto;" class="layui-form layui-form-item">
                            <div style="float: left;">
                                <div class="layui-form-item">
                                    ...
                                    <div class="layui-input-inline">
                                        <asp:TextBox ID="TextBox1" runat="server" placeholder="请输入姓名" autocomplete="off" class="layui-input"></asp:TextBox>
                                    </div>
                                </div>
                            </div>
                            <span></span>
                            ...
                            <a class="layui-btn" onclick="ShowWindow('修改信息','EmployeeAdd.aspx','50%', '50%',2,false,true,true,false,true)">
                        ...
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Label ID="LabVisible" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "EID")%>'
                                    ...
                                    <asp:TemplateField HeaderText="员工姓名">
                                        <ItemTemplate>
                                            <i></i>
                                            <a onclick="ShowWindow('修改信息','EmployeeAdd.aspx?EID=<%# Eval("EID") %>','50%', '50%',2,false,true,true,false,true)">
                                                <%#(Eval("EmployeeName").ToString())%> </a>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="工作时长">
                                        <ItemTemplate>
                                            <i></i>
                                            <%#(Eval("EmployeeTime")+"小时")%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <a class="layui-btn layui-btn-sm" onclick=" ShowWindow('修改信息','EmployeeAdd.aspx?EID=<%# Eval("EID") %>','50%', '50%',2,false,true,true,false,true)">
