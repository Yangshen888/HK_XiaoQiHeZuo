<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PersonParticipate.aspx.cs" Inherits="HaikanSchoolProjects.General.Statistical.PersonParticipate" %>
    ...
    <div id="page_wrapper">
        <form id="form1" runat="server" class="layui-form-pane">
            ...
            <blockquote class="layui-elem-quote" style="margin-left: 190px;">
                <div style="float: left;">
                    <div class="layui-form-item">
                        ...
                        <div class="layui-input-inline">
                            <asp:DropDownList  Height="38px" ID="DropDownListXM" runat="server" Width="140px"></asp:DropDownList>
                        </div>
                    </div>
                </div>
                ...
                <a class="layui-btn layui-btn-normal" href="PersonParticipate.aspx"  >
