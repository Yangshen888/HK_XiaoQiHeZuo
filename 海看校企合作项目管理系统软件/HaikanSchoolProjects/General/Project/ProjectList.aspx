<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ProjectList.aspx.cs" Inherits="HaikanSchoolProjects.General.Project.ProjectList" %>
                ...
                <div id="mymain">
                    ...
                    <blockquote class="layui-elem-quote">
                        <div style="margin-bottom: auto;" class="layui-form layui-form-item">
                            ...
                            <a class="layui-btn" onclick="ShowWindow('添加','ProjectAdd.aspx','50%', '50%',2,false,true,true,false,true)">
                        ...
                        <ContentTemplate>
                            ...
                            <asp:GridView ID="GVData" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateColumns="False"
                                ...
                                <Columns>
                                    <asp:TemplateField>
                                        <ItemTemplate>
                                            <asp:Label ID="LabVisible" runat="server" Text='<%#DataBinder.Eval(Container.DataItem, "ProjectID")%>'
                                    ...
                                    <asp:TemplateField HeaderText="项目状态">
                                        <ItemTemplate>
                                            <i></i>
                                            <%#(Eval("Projectstatus").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:TemplateField HeaderText="主要负责人">
                                        <ItemTemplate>
                                            <i></i>
                                            <%#(Eval("PersonInCharge").ToString())%>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    ...
                                    <asp:TemplateField HeaderText="操作">
                                        <ItemTemplate>
                                            <a class="layui-btn layui-btn-sm" onclick=" ShowWindow('修改信息','ProjectAdd.aspx?ProjectID=<%# Eval("ProjectID") %>','50%', '50%',2,false,true,true,false,true)">
